...
$_['text_title']            = 'Custom Report';
$_['text_list']             = 'List';
$_['text_add']              = 'Add Custom Report';
$_['text_edit']             = 'Edit Custom Report';

# Columns
$_['column_customer_name']  = 'Customer Name';
$_['column_name']           = 'Column Name';
$_['column_sort_order']     = 'Sort Order';
$_['column_action']         = 'Action';

# Entry
$_['entry_name']            = 'Customer Name';
$_['entry_custom_name']     = 'Name';
$_['entry_field_name']      = 'Field Name';
$_['entry_sort_order']      = 'Sort Order';
$_['entry_access']          = 'Report Order';
$_['entry_modify']          = 'Modify Permission';
$_['entry_delete']          = 'Delete Permission';

# Error
$_['error_permission']      = 'Warning: You do not have permission to add/modify user groups!';
$_['error_delete']          = 'Warning: You do not have permission to delete user groups!';
