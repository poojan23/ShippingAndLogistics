<?php
# HTTP
define('HTTP_SERVER', 'http://localhost/ShippingAndLogistics/launch/');
define('HTTP_CATALOG', 'http://localhost/ShippingAndLogistics/');

# HTTPS
define('HTTPS_SERVER', 'http://localhost/ShippingAndLogistics/launch/');
define('HTTPS_CATALOG', 'http://localhost/ShippingAndLogistics/');

# DIR
define('DIR_ROOT', 'C:/ATDI/LMS/htdocs/ShippingAndLogistics/');
define('DIR_APPLICATION', 'C:/ATDI/LMS/htdocs/ShippingAndLogistics/launch/');
