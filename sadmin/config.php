<?php
# HTTP
define('HTTP_SERVER', 'http://localhost/ShippingAndLogistics/sadmin/');
define('HTTP_ADMIN', 'http://localhost/ShippingAndLogistics/admin/');
define('HTTP_CATALOG', 'http://localhost/ShippingAndLogistics/');

# HTTPS
define('HTTPS_SERVER', 'http://localhost/ShippingAndLogistics/sadmin/');
define('HTTPS_ADMIN', 'http://localhost/ShippingAndLogistics/admin/');
define('HTTPS_CATALOG', 'http://localhost/ShippingAndLogistics/');

# DIR
define('DIR_APPLICATION', 'C:/ATDI/LMS/htdocs/ShippingAndLogistics/sadmin/');
...
define('DIR_ADMIN', 'C:/ATDI/LMS/htdocs/ShippingAndLogistics/admin/');
