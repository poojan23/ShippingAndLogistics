...
class ControllerCustomerLogin extends PT_Controller
{
    private $error = array();
    ...
    public function index()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('customer/login')
        );

    
        if ($this->customer->isLogged()) {
            $this->response->redirect($this->url->link('customer/dashboard'));
        }
        ...
        $data['action'] = $this->url->link('customer/login');
